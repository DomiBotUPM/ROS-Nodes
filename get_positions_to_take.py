...
class valores_piezas_robot:
    def __init__(self):
        ...
        #subscribers
        self.subscriber_take_piece = rospy.Subscriber('/play_robot/take_piece', Bool, self.take_piece_callback, queue_size=1)
        
        #publishers
        self.publisher_take_piece = rospy.Publisher('/play_robot/take_piece', Bool, queue_size=1)
        self.publisher_posicion_pieza = rospy.Publisher('/vision/posicion_pieza', Float64MultiArray, queue_size=10)              
